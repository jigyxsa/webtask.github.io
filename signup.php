...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty(trim($_POST["firstname"]))){
        $username_err = "First name cannot be blank";
    }
...
if(empty($username_err) && empty($password_err) && empty($confirm_password_err))
{
    ...
    if ($stmt)
    {
        mysqli_stmt_bind_param($stmt, "sss", $param_firstname, $param_lastname, $param_password);
            ...
            <form action="" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" id="lastName" name="firstname" class="form-control form-control-lg" />
